...
//    // отладочный вывод, чтобы проверить, сколько столов доступно
//    System.out.println("Всего столов: " + availableTables.size());
...
//    // отладочный вывод, чтобы проверить, сколько столов доступно после фильтрации
//    System.out.println("Доступные столики после фильтрации: " + unreservedTables.size());
